  ...
  <el-row :gutter="30">
    ...
    <el-col :span="14">
      <div class="grid-content">
        ...
        <el-date-picker style="width: 234px" v-model="temp_begin_time" type="date" placeholder='开始时间'
                        value-format="yyyy-MM-dd"/>
        <el-date-picker style="width: 234px" v-model="temp_end_time" type="date" placeholder='结束时间'
                        value-format="yyyy-MM-dd"/>
