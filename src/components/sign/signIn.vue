<template>
  <div class="">
    ...
    <div class="">
      <div class="myButton">
        <el-button type="success" size="medium" @click="handleSignIn">
          签到
        </el-button>
        <el-button type="danger" size="medium" @click="handleSignOut">
          签退
        </el-button>
      </div>
      <div class="submitButton">
        <el-button type="primary" size="small" @click="handleTimeoff">
          请假申请
        </el-button>
      </div>
    </div>
    ...
    >
      <!-- 主体区 -->
      <el-form :model="signInForm" label-position="right" label-width="100px">
    ...
    >
      <!-- 主体区 -->
      <el-form :model="signOutForm" label-position="right" label-width="100px">
