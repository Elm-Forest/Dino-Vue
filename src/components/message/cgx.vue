        ...
        <el-table v-loading="listLoading" :data="list2" element-loading-text="Loading" border
          ...
          <el-table-column label="操作" width="300" align="center">
            <template slot-scope="scope">
              ...
              <el-button type="success" size="mini" @click="edit(scope.row.id, scope.$index)">
                继续编辑
              </el-button>
  ...
  methods: {
    edit(id) {
      ...
      this.$axios({
        ...
        _this.editForm.title = res.data.emailTitle
        _this.editForm.contacts.id = res.data.auId
        _this.editForm.contacts.name = res.data.acceptUserName
